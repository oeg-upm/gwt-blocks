...
a) As presenter/display  <a name="useAsPresenter"></a>
...
~~~
b) Use widgets <a name="useWidgets"></a> 
b.a) Use Loading widget  <a name="loadingWidget"></a>
...
b.b) Use PrettyPopup  <a name="prettyPopup"></a>
Create style:  
